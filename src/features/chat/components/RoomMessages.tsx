...
export default function RoomMessages({ roomId }: Props) {
  ...
  return (
    <>
                              ...
                              {message.type === "TEXT" ? (
                                ...
                                >
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      setViewImage(message.content_url)
                                    }
                                    className="absolute transform -translate-x-1/2 left-1/2 bottom-[10px] flex items-center gap-1  border border-[#D7D7D7]/10 rounded-xl py-2 px-3 overflow-hidden bg-[#34343c] cursor-pointer"
                                  >
                                    <img
      ...
      {infoGroupModal && room?.Group && (
        <GroupInfoModal
          onClose={() => setInfoGroupModal(false)}
          group={room?.Group}
