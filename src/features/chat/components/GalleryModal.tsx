    ...
    >
      ...
      >
        ...
        <button
          id="Btn-Close"
          onClick={() => onClose()}
          className="preview-img absolute transform -translate-x-1/2 left-1/2 bottom-[30px] flex items-center gap-1  border border-[#D7D7D7]/10 rounded-xl py-2 px-3 overflow-hidden bg-[#A79E9E36] cursor-pointer"
        >
          <img
