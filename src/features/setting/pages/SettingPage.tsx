                ...
                <div className="flex items-center gap-[12px]">
                  <div className="group flex flex-col gap-[12px] relative">
                    ...
                    <div className="flex relative items-center justify-center overflow-hidden w-[210px] h-[140px] shrink-0 rounded-2xl">
                      ...
                      />
                      <span className="absolute top-[3px] left-[3px] right-[3px] bottom-[3px] rounded-xl z-20 group-hover:ring-4 group-has-[:checked]:ring-4 group-hover:ring-heyhao-blue group-has-[:checked]:ring-heyhao-blue transition-all duration-300"></span>
                      <img
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div
                          id="Point-Bar"
                          className="absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 size-5 rounded-full bg-heyhao-blue ring-[2px] ring-white shrink-0"
                        ></div>
                      </div>
                    </div>
                  </div>
