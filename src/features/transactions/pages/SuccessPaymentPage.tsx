...
export default function SuccessPaymentPage() {
  ...
  const { data, isLoading } = useTransaction(order_id ?? "");
  ...
  return (
    <div className="relative flex justify-center min-h-screen max-h-screen flex-1 bg-heyhao-grey overflow-hidden pt-[calc(((100vh-832px)/2)+56px)]">
      <img
        src="/assets/images/backgrounds/ornament-payment-success.png"
        alt="image"
      ...
      <div className="overflow-y-auto [&::-webkit-scrollbar]:hidden h-screen overflow-x-hidden">
        {!isLoading && (
          <div className="relative w-[500px] z-10 p-6 rounded-[32px] bg-[linear-gradient(180deg,_#FFFFFF_65.04%,_rgba(255,_255,_255,_0.5)_100%)] flex flex-col h-fit gap-6 backdrop-blur-md border border-white">
            <img
              src="/assets/images/icons/polygon-3.svg"
              alt="icon"
              className="absolute top-[190px] right-[-22.5px]"
            />
            <img
              src="/assets/images/icons/polygon-3.svg"
              alt="icon"
              className="absolute top-[190px] left-[-22.5px] rotate-180"
            />
            <header className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 text-center">
                ...
                <p className="font-medium leading-5 text-heyhao-secondary">
                  Payment Confirmed, All Good! 😉
                </p>
              </div>
            </header>
            ...
            <div className="flex flex-col gap-6">
              <section id="Card" className="flex items-center justify-between">
                <div className="flex items-center gap-[12px]">
                  <div className="flex justify-center items-center size-[64px] shrink-0 rounded-full overflow-hidden">
                    <img
                      src={data?.group.photo_url}
                      alt="image"
                      className="size-full object-cover"
                    />
                  </div>
                  <div className="flex flex-col gap-1 relative z-10">
                    <h2 className="line-clamp-1 font-semibold text-lg leading-[22.5px]">
                      {data?.group.name}
                    </h2>
                    <div className="flex items-center gap-1">
                      ...
                      <div className="flex gap-1">
                        <p className="font-semibold text-sm leading-[17.5px] text-heyhao-green">
                          {data?.group.room._count.RoomMember}
                        </p>
                        <p className="font-semibold text-sm leading-[17.5px] text-heyhao-green">
                          Members
                        </p>
              ...
              <section
                id="Payment-Details"
                className="p-4 rounded-2xl flex flex-col gap-4 border border-heyhao-border"
              >
                <h3 className="font-semibold text-lg leading-[22.5px]">
                  Payment Details
                </h3>
                <div className="flex flex-col gap-[12px]">
                  <div className="flex items-center justify-between">
                    ...
                    <strong className="font-semibold leading-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <strong className="font-semibold leading-5">
                      {formatDate(data?.createdAt ?? new Date(), "HH:mm")}
                    </strong>
                  </div>
                  <div className="flex items-center justify-between">
                    <p className="font-medium text-sm leading-[17.5px] text-heyhao-secondary">
                    ...
                    <strong className="flex items-center gap-1">
                      ...
                      />
                      <p className="font-semibold leading-5 text-[#2F80C1]">
                        Midtrans
                      </p>
                    </strong>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <strong className="font-semibold text-2xl leading-[30px] text-heyhao-coral">
              ...
              <section id="Buttons" className="flex flex-col gap-4">
                <Link to="/home/chats">
                  <div className="rounded-full bg-heyhao-blue py-4 text-white w-full font-bold leading-[20px] text-center">
                    Join Group Now
                  </div>
                </Link>
                <Link to="/home/discover">
                  <div className="rounded-full bg-heyhao-black py-4 text-white w-full font-bold leading-[20px] text-center">
                    Discover More Group
                  </div>
                </Link>
              </section>
